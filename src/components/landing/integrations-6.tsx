        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mx-auto max-w-md px-6 [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_70%,transparent_100%)]">
            <div className="bg-background dark:bg-muted/50 rounded-xl border px-6 pb-12 pt-3 shadow-xl">
              <Integration
                icon={<Gemini />}
                name="Facebook Ads"
                description="Create and publish ads directly to Facebook Ads Manager."
              />
              <Integration
                icon={<Replit />}
                name="Google Ads"
                description="Generate search and display ads optimized for Google's platform."
              />
              <Integration
                icon={<GooglePaLM />}
                name="Instagram Ads"
                description="Design stunning visual ads for Instagram Stories and Feed."
              />
            </div>
          </div>
          <div className="mx-auto mt-6 max-w-lg space-y-6 text-center">
            ...
            <p className="text-muted-foreground">
              Seamlessly integrate with Facebook Ads, Google Ads,
              Instagram, LinkedIn, and more. Publish your AI-generated
              ads directly to your campaigns.
            </p>
